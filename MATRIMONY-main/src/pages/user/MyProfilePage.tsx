    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start justify-between gap-6 text-center md:text-left">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6">
            <div className="relative group">
              {profile.avatar ? (
                <img
                  src={profile.avatar}
                  alt={profile.name}
                  className="h-28 w-28 sm:h-32 sm:w-32 rounded-3xl object-cover ring-4 ring-[#D4AF37] shadow-xl"
                />
              ) : (
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-center md:justify-start gap-2 flex-wrap">
                ...
                <span className="text-xs text-amber-200 font-semibold flex items-center gap-1 bg-black/30 px-3 py-0.5 rounded-full border border-amber-300/30">
              ...
              <div className="flex items-center justify-center md:justify-start gap-4 text-xs text-stone-200 flex-wrap font-medium">
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-end gap-3 shrink-0">
            <button
              type="button"
              onClick={() => navigate('/profile/edit')}
              className="px-5 py-2.5 rounded-xl text-xs font-extrabold bg-gradient-to-r from-[#D4AF37] to-[#AA7C11] text-stone-950 hover:brightness-105 shadow-md transition-all flex items-center gap-2 cursor-pointer"
            >
            ...
            <button
              ...
              className="px-4 py-2.5 rounded-xl text-xs font-extrabold bg-white/20 hover:bg-white/30 text-white border border-white/40 shadow-sm transition-all flex items-center gap-2 cursor-pointer backdrop-blur-md"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-4 space-y-6">
          {/* Quick Summary Card */}
          <Card className="p-6 bg-white border border-stone-200/90 shadow-lg rounded-3xl space-y-4">
            <h3 className="font-serif text-lg font-extrabold text-[#8B1E3F] flex items-center gap-2">
              <User className="h-5 w-5 text-[#8B1E3F]" /> Quick Overview
            </h3>

            <div className="space-y-3.5 text-xs divide-y divide-stone-200/70">
              <div className="pt-2 flex justify-between items-center">
                <span className="text-stone-800 font-extrabold uppercase tracking-wider text-[11px]">Marital Status</span>
              ...
              <div className="pt-3.5 flex justify-between items-center">
                <span className="text-stone-800 font-extrabold uppercase tracking-wider text-[11px]">Religion & Caste</span>
                <span className="font-extrabold text-[#8B1E3F] text-xs">{profile.religion} ({profile.caste})</span>
              </div>

              <div className="pt-3.5 flex justify-between items-center">
                <span className="text-stone-800 font-extrabold uppercase tracking-wider text-[11px]">Height & Weight</span>
                <span className="font-extrabold text-stone-950 text-xs">{profile.height} / {profile.weight}</span>
              </div>

              <div className="pt-3.5 flex justify-between items-center">
                <span className="text-stone-800 font-extrabold uppercase tracking-wider text-[11px]">Annual Income</span>
                <span className="font-extrabold text-emerald-800 text-xs">{profile.annual_income}</span>
              </div>

              <div className="pt-3.5 flex justify-between items-center">
                <span className="text-stone-800 font-extrabold uppercase tracking-wider text-[11px]">Diet Habit</span>
                <span className="font-extrabold text-stone-950 text-xs">{profile.diet}</span>
              </div>

              <div className="pt-3.5 flex justify-between items-center">
                <span className="text-stone-800 font-extrabold uppercase tracking-wider text-[11px]">Smoking / Drinking</span>
                <span className="font-extrabold text-stone-950 text-xs">{profile.smoking} / {profile.drinking}</span>
              </div>

              <div className="pt-3.5 flex justify-between items-center">
                <span className="text-stone-800 font-extrabold uppercase tracking-wider text-[11px]">Rashi / Nakshatra</span>
          ...
          <Card className="p-6 bg-gradient-to-br from-[#8B1E3F]/10 via-white to-amber-500/10 border border-[#8B1E3F]/30 shadow-lg rounded-3xl space-y-3">
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          {/* About Me Section */}
          <Card className="p-8 bg-white border border-stone-200/90 shadow-lg rounded-3xl space-y-4">
            ...
            <p className="text-sm text-stone-900 leading-relaxed whitespace-pre-line font-bold">
              {profile.about_me}
            </p>
          </Card>

          {/* Education & Career Details */}
          <Card className="p-8 bg-white border border-stone-200/90 shadow-lg rounded-3xl space-y-6">
            <div className="flex items-center justify-between border-b border-stone-200 pb-4">
              <h3 className="font-serif text-xl font-extrabold text-[#8B1E3F] flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="space-y-1.5 p-4 bg-stone-50 rounded-2xl border border-stone-200/90 hover:border-[#8B1E3F]/40 transition-all">
                <span className="text-[11px] text-stone-800 font-extrabold uppercase tracking-wider block">Highest Qualification</span>
                <p className="text-sm font-extrabold text-stone-950">{profile.highest_education}</p>
              </div>

              <div className="space-y-1.5 p-4 bg-stone-50 rounded-2xl border border-stone-200/90 hover:border-[#8B1E3F]/40 transition-all">
                <span className="text-[11px] text-stone-800 font-extrabold uppercase tracking-wider block">Occupation / Profession</span>
                <p className="text-sm font-extrabold text-stone-950">{profile.occupation}</p>
              </div>

              <div className="space-y-1.5 p-4 bg-stone-50 rounded-2xl border border-stone-200/90 hover:border-[#8B1E3F]/40 transition-all">
                <span className="text-[11px] text-stone-800 font-extrabold uppercase tracking-wider block">Annual Income</span>
                <p className="text-sm font-extrabold text-emerald-800">{profile.annual_income}</p>
              </div>

              <div className="space-y-1.5 p-4 bg-stone-50 rounded-2xl border border-stone-200/90 hover:border-[#8B1E3F]/40 transition-all">
                <span className="text-[11px] text-stone-800 font-extrabold uppercase tracking-wider block">Current Location</span>
                <p className="text-sm font-extrabold text-stone-950">{profile.city}, {profile.state}, {profile.country}</p>
              </div>
            </div>
          </Card>
          ...
          <Card className="p-8 bg-white border border-stone-200/90 shadow-lg rounded-3xl space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="space-y-1.5 p-4 bg-stone-50 rounded-2xl border border-stone-200/90 hover:border-[#8B1E3F]/40 transition-all">
                <span className="text-[11px] text-stone-800 font-extrabold uppercase tracking-wider block">Religion</span>
                <p className="text-sm font-extrabold text-stone-950">{profile.religion}</p>
              </div>

              <div className="space-y-1.5 p-4 bg-stone-50 rounded-2xl border border-stone-200/90 hover:border-[#8B1E3F]/40 transition-all">
                <span className="text-[11px] text-stone-800 font-extrabold uppercase tracking-wider block">Caste / Community</span>
                <p className="text-sm font-extrabold text-stone-950">{profile.caste}</p>
              </div>

              <div className="sm:col-span-2 space-y-1.5 p-4 bg-stone-50 rounded-2xl border border-stone-200/90 hover:border-[#8B1E3F]/40 transition-all">
                <span className="text-[11px] text-stone-800 font-extrabold uppercase tracking-wider block">Family Information</span>
                <p className="text-sm font-extrabold text-stone-950 leading-relaxed">{profile.family_information}</p>
              </div>
            </div>
          </Card>
          ...
          <Card className="p-8 bg-white border border-stone-200/90 shadow-lg rounded-3xl space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="p-4 bg-amber-100/60 border border-amber-300 rounded-2xl space-y-1">
                <span className="text-[11px] font-extrabold text-stone-900 uppercase tracking-wider block">Moon Sign (Rashi)</span>
                <p className="text-sm font-extrabold text-[#8B1E3F]">{profile.rashi}</p>
              </div>

              <div className="p-4 bg-amber-100/60 border border-amber-300 rounded-2xl space-y-1">
                <span className="text-[11px] font-extrabold text-stone-900 uppercase tracking-wider block">Star (Nakshatra)</span>
                <p className="text-sm font-extrabold text-[#8B1E3F]">{profile.nakshatra}</p>
              </div>

              <div className="p-4 bg-amber-100/60 border border-amber-300 rounded-2xl space-y-1">
                <span className="text-[11px] font-extrabold text-stone-900 uppercase tracking-wider block">Dosha Status</span>
                <p className="text-sm font-extrabold text-[#8B1E3F]">{profile.dosha}</p>
              </div>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-2">
              <div className="space-y-1.5 p-4 bg-stone-50 rounded-2xl border border-stone-200/90 hover:border-[#8B1E3F]/40 transition-all">
                <span className="text-[11px] text-stone-800 font-extrabold uppercase tracking-wider block">Languages Known</span>
                <p className="text-sm font-extrabold text-stone-950">{profile.languages_known}</p>
              </div>

              <div className="space-y-1.5 p-4 bg-stone-50 rounded-2xl border border-stone-200/90 hover:border-[#8B1E3F]/40 transition-all">
                <span className="text-[11px] text-stone-800 font-extrabold uppercase tracking-wider block">Hobbies & Interests</span>
                <p className="text-sm font-extrabold text-stone-950">{profile.hobbies_interests}</p>
              </div>
            </div>
          </Card>
