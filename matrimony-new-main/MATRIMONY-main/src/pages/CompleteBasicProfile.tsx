...
import { CheckCircle2, Loader2, UserCheck, Eye, EyeOff, Lock, LogOut } from 'lucide-react';
          ...
          {!isSuccess ? (
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div className="space-y-2.5 pt-2">
                <Button
                  ...
                  className="w-full font-bold shadow-lg shadow-[#8B1E3F]/20 text-sm h-12"
                >
                  {isSubmitting ? (
                    <>
                ...
                <button
                  ...
                  className="w-full py-2.5 text-xs font-bold text-stone-500 hover:text-stone-800 transition-colors flex items-center justify-center gap-1.5"
                >
            ...
            >
              ...
              <div className="pt-4 flex flex-col gap-2">
                ...
                >
                  <LogOut className="h-3.5 w-3.5 mr-1" /> Log Out & Resume Later
                </Button>
              </div>
            </motion.div>
          )}
