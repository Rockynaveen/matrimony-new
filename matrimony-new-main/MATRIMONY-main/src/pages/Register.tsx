...
export const Register: React.FC = () => {
  ...
  const onSubmit = async (data: RegisterFormData) => {
    try {
      ...
      // Manual Registration Flow: Immediately redirect to Complete Profile (/profile/complete)
      showToast('Registration successful! Please complete your detailed matrimonial profile.');
  ...
  const handleGoogleTokenSuccess = async (idToken: string) => {
    ...
    try {
      ...
      // Google Registration Flow: Redirect to Basic Profile page (/complete-basic-profile)
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-3.5 my-auto py-1.5">
            ...
            <div className="space-y-2 pt-1">
              ...
              <Button
                ...
                className="w-full font-bold border-2 border-stone-200 bg-white text-stone-800 hover:bg-stone-100 hover:text-stone-900 hover:border-stone-300 text-xs h-10 flex items-center justify-center gap-2 rounded-xl transition-all"
              >
                ...
                <span className="text-stone-800 font-bold">Register with Google</span>
              </Button>
            </div>
          </form>
