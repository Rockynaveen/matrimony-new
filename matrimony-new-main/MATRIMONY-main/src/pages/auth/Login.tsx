          ...
          <Card className="p-8 shadow-2xl bg-white/95 backdrop-blur-xl border-border/80 rounded-3xl space-y-6">
            ...
            <div className="pt-4 border-t border-border/60 space-y-3">
              ...
              <Button
                ...
                className="w-full text-xs font-bold cursor-pointer border-2 border-stone-200 bg-white text-stone-800 hover:bg-stone-100 hover:text-stone-900 hover:border-stone-300"
              >
